// TODO: REVIEW: copied from tutorial source.
// TODO: Needs a lot of work on input handling.

import 'dart:async';
import 'package:mcalc/widgets/calculatorkeybutton.dart';
import 'package:mcalc/widgets/keycontroller.dart';
import 'package:mcalc/models/calculatorkey.dart';
...
abstract class Processor {
  ...
  static process(dynamic event) {
    ...
    CalculatorKeyButton key = (event as KeyEvent).key;
  ...
  static void handleFunction(CalculatorKeyButton key) {
  ...
  static void handleOperator(CalculatorKeyButton key) {
  ...
  static void handleInteger(CalculatorKeyButton key) {
