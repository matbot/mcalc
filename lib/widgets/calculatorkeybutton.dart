...
class CalculatorKeyButton extends StatelessWidget {
  ...
  CalculatorKeyButton({this.symbol});
  ...
  static dynamic _fire(CalculatorKeyButton key) => KeyController.fire(KeyEvent(key));

  @override
  Widget build(BuildContext context) {
    double size = MediaQuery.of(context).size.width / 4;
    TextStyle buttonTextStyle = Theme.of(context).textTheme.headline4
    ...
    return Container(
      ...
      child: RaisedButton(
        ...
        color: color,
        elevation: 4,
        child: Text(symbol.value, style: buttonTextStyle),
